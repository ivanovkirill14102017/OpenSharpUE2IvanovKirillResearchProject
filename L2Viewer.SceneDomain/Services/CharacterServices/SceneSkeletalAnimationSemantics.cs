...
internal static class SceneSkeletalAnimationSemantics
{
    ...
    private static IReadOnlyList<SceneSkeletalAnimationNotify> MapNotifies(UkxFile.UkxFile ukx, IReadOnlyList<UkxMeshAnimNotify> notifies)
    {
        return notifies
            .Select(notify =>
            {
    ...
    private static string? ResolveNotifyClassName(UkxFile.UkxFile ukx, UkxMeshAnimNotify notify)
    {
