...
public sealed class SceneActorPreviewBuilder
{
    private readonly SceneStaticMeshResolver _staticMeshResolver;

    public SceneActorPreviewBuilder(SceneStaticMeshResolver staticMeshResolver)
    {
        _staticMeshResolver = staticMeshResolver;
    }

    public SceneActorPreviewData? Build(string packagePath, L2Viewer.UnrFile.UnrFile unr, int exportIndex)
    {
        ...
        return new SceneActorPreviewData
        {
